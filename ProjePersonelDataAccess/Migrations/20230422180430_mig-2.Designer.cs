...
namespace ProjePersonelDataAccess.Migrations
{
    ...
    [Migration("20230422180430_mig-2")]
    partial class mig2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Departman", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmanID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 277, DateTimeKind.Local).AddTicks(9869),
                        ...
                        {
                            DepartmanID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 277, DateTimeKind.Local).AddTicks(9872),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.EducationStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EducationID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(4082),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Gender", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GenderID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(1637),
                            GenderName = "Kadın",
                            IsActive = true,
                            IsDeleted = false
                        },
                        ...
                        {
                            GenderID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(1640),
                            GenderName = "Erkek",
                            IsActive = true,
                            IsDeleted = false
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Mission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MissionID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(1120),
                            DepartmanID = 1,
                        ...
                        {
                            MissionID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(1126),
                            DepartmanID = 2,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonelPhoneNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 278, DateTimeKind.Local).AddTicks(1767),
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 278, DateTimeKind.Local).AddTicks(9792),
                            DepartmanID = 1,
                            EducationID = 1,
                            ...
                            Surname = "Yılmaz",
                            UpdateDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 278, DateTimeKind.Local).AddTicks(9797)
                        });
                });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonnelAddress", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 278, DateTimeKind.Local).AddTicks(3397),
                            IsActive = true,
                            IsDeleted = false,
                            PersonnelID = 1
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PlaceOfBirth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityID = 1,
                            CityName = "Adana",
                            CreatedDateTime = new DateTime(2023, 4, 22, 21, 4, 30, 279, DateTimeKind.Local).AddTicks(2896),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
