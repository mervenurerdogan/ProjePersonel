...
namespace ProjePersonelDataAccess.Migrations
{
    ...
    [Migration("20230422191912_mig-ıdentityunique")]
    partial class migıdentityunique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Departman", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmanID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 210, DateTimeKind.Local).AddTicks(340),
                        ...
                        {
                            DepartmanID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 210, DateTimeKind.Local).AddTicks(343),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.EducationStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EducationID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(5481),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Gender", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GenderID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(3018),
                            GenderName = "Kadın",
                            IsActive = true,
                            IsDeleted = false
                        },
                        ...
                        {
                            GenderID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(3019),
                            GenderName = "Erkek",
                            IsActive = true,
                            IsDeleted = false
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Mission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MissionID = 1,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(2417),
                            DepartmanID = 1,
                        ...
                        {
                            MissionID = 2,
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(2420),
                            DepartmanID = 2,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonelPhoneNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 210, DateTimeKind.Local).AddTicks(2108),
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(1064),
                            DepartmanID = 1,
                            EducationID = 1,
                            ...
                            Surname = "Yılmaz",
                            UpdateDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(1064)
                        });
                });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonnelAddress", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 210, DateTimeKind.Local).AddTicks(3888),
                            IsActive = true,
                            IsDeleted = false,
                            PersonnelID = 1
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PlaceOfBirth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityID = 1,
                            CityName = "Adana",
                            CreatedDateTime = new DateTime(2023, 4, 22, 22, 19, 12, 211, DateTimeKind.Local).AddTicks(4292),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
