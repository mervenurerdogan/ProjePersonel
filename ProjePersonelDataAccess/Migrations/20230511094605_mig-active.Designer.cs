...
namespace ProjePersonelDataAccess.Migrations
{
    ...
    [Migration("20230511094605_mig-active")]
    partial class migactive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Departman", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmanID = 1,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 201, DateTimeKind.Local).AddTicks(6470),
                        ...
                        {
                            DepartmanID = 2,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 201, DateTimeKind.Local).AddTicks(6472),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.EducationStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EducationID = 1,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 203, DateTimeKind.Local).AddTicks(648),
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Gender", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GenderID = 1,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(8195),
                            GenderName = "Kadın",
                            IsActive = true,
                            IsDeleted = false
                        },
                        ...
                        {
                            GenderID = 2,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(8197),
                            GenderName = "Erkek",
                            IsActive = true,
                            IsDeleted = false
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Mission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MissionID = 1,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(7774),
                            DepartmanID = 1,
                        ...
                        {
                            MissionID = 2,
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(7775),
                            DepartmanID = 2,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonelPhoneNumber", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 201, DateTimeKind.Local).AddTicks(8241),
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.Personnel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(6523),
                            DepartmanID = 1,
                            EducationID = 1,
                            ...
                            Surname = "Yılmaz",
                            UpdateDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(6524)
                        });
                });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PersonnelAddress", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 201, DateTimeKind.Local).AddTicks(9745),
                            IsActive = true,
                            IsDeleted = false,
                            PersonnelID = 1
                        });
            ...
            modelBuilder.Entity("ProjePersonelModel.Entities.PlaceOfBirth", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityID = 1,
                            CityName = "Adana",
                            CreatedDateTime = new DateTime(2023, 5, 11, 12, 46, 5, 202, DateTimeKind.Local).AddTicks(9467),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
